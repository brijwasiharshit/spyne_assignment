...
const UserListings = () => {
  ...
  useEffect(() => {
    const fetchCars = async () => {
      try {
        const res = await axios.get('https://spyne-assignment-yoq5.onrender.com/api/v1/getAllCars', {
  ...
  const handleLogout = async () => {
    try {
      const res = await axios.get('https://spyne-assignment-yoq5.onrender.com/api/v1/logout', {
        withCredentials: true,
      });
